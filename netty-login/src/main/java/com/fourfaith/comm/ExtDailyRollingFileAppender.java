/** 
 * Project Name:device-comm 
 * File Name:ExtDailyRollingFileAppender.java 
 * Package Name:com.fourfaith.device.comm 
 * Date:2016楠烇拷1閺堬拷8閺冦儰绗傞崡锟�12:12:44 
 * Copyright (c) 2016, Four-Faith All Rights Reserved. 
 */
...
/**
 * ExtDailyRollingFileAppender extends {@link FileAppender} so that the
 ...
 */
public class ExtDailyRollingFileAppender extends FileAppender {
	 ...
	 */
	public ExtDailyRollingFileAppender() {
	}
	 ...
	 */
	public ExtDailyRollingFileAppender(Layout layout, String filename, String datePattern) throws IOException {
	...
	void sizeRollOver() {
		...
		if (maxBackupIndex > 0) {
			...
			LogLog.debug("Renaming file " + file + " to " + target);
			// file.renameTo(target);//modify by suzhongqing
			copy(file, target);// add by suzhongqing
...
class RollingCalendar extends GregorianCalendar {
	...
	int type = ExtDailyRollingFileAppender.TOP_OF_TROUBLE;
	...
	public Date getNextCheckDate(Date now) {
		...
		switch (type) {
		case ExtDailyRollingFileAppender.TOP_OF_MINUTE:
			this.set(Calendar.SECOND, 0);
			this.set(Calendar.MILLISECOND, 0);
			this.add(Calendar.MINUTE, 1);
			break;
		case ExtDailyRollingFileAppender.TOP_OF_HOUR:
			this.set(Calendar.MINUTE, 0);
			this.set(Calendar.SECOND, 0);
			this.set(Calendar.MILLISECOND, 0);
			this.add(Calendar.HOUR_OF_DAY, 1);
			break;
		case ExtDailyRollingFileAppender.HALF_DAY:
			this.set(Calendar.MINUTE, 0);
			this.set(Calendar.SECOND, 0);
			this.set(Calendar.MILLISECOND, 0);
			...
			break;
		case ExtDailyRollingFileAppender.TOP_OF_DAY:
			this.set(Calendar.HOUR_OF_DAY, 0);
			this.set(Calendar.MINUTE, 0);
			this.set(Calendar.SECOND, 0);
			this.set(Calendar.MILLISECOND, 0);
			...
			break;
		case ExtDailyRollingFileAppender.TOP_OF_WEEK:
			...
			break;
		case ExtDailyRollingFileAppender.TOP_OF_MONTH:
